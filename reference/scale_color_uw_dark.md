...
Uses
[uw_palette_dark](https://cdmuir.github.io/uwbranding/reference/uw_palette_dark.md),
ordered for contrast on dark panels. Red-family colors are placed last
because they are low-contrast on a Badger Red background.
